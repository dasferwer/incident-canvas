...
function SidebarProvider({
  ...
  // Если родитель не управляет панелью, храним её состояние здесь.
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // Cookie сохраняет выбор пользователя между открытиями страницы.
  ...
  // Тот же переключатель доступен с клавиатуры.
  React.useEffect(() => {
  ...
  // CSS выбирает стили раскрытой и свёрнутой панели по data-state.
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          // Отступы зависят от того, встроена панель или расположена поверх страницы.
          variant === 'floating' || variant === 'inset'
...
function SidebarMenuSkeleton({
  ...
  // Разная ширина делает заглушки похожими на строки текста.
